...
//        echo $this->wxLoginUrl;die;
        ...
        if (empty($wxResult)) {
            ...
            if ($loginFail) {
                ...
                //获取到了access_token,现在去获取用户信息
                $this->userInfoUrl = sprintf(
                    config('wx.userInfo_url'),$wxResult['access_token'],$wxResult['openid']
                );
//                echo $this->userInfoUrl;
//                die;
                $userInfo = curl_get($this->userInfoUrl);
